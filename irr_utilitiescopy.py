...
""",
    ...
    try:
        ...
        shares_classes = {
            ...
            "ENGI3": 887_231_247,
            "ENGI4": 1_402_193_416,
            "ENGI11": 502_800_000,  # nº de ações ENGI11
            "EQTL3": 1_255_510_000,
            "SBSP3": 683_510_000,
            "NEOE3": 1_213_800_000,
            "ENEV3": 1_936_970_000,
        ...
        for t in final_tickers:
            if t == "IGTI11":
                ...
                shares_cple6 = shares_classes["CPLE6"]

                price = price_cple3  # para exibição (ticker principal)
                shares = shares_cple3 + shares_cple6

                parts = []
                if pd.notna(price_cple3):
                    parts.append(price_cple3 * shares_cple3)
                if pd.notna(price_cple6):
                    parts.append(price_cple6 * shares_cple6)
